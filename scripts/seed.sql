...
('uu000000-0000-0000-0000-000000000004', @company_id, 'LTR',  'Liter',    1, @now, @now),
('uu000000-0000-0000-0000-000000000005', @company_id, 'MTR',  'Meter',    1, @now, @now),
('uu000000-0000-0000-0000-000000000006', @company_id, 'BOX',  'Box',      1, @now, @now),
('uu000000-0000-0000-0000-000000000007', @company_id, 'SET',  'Set',      1, @now, @now),
('uu000000-0000-0000-0000-000000000008', @company_id, 'UNIT', 'Unit',     1, @now, @now);

-- ── Payment Terms ────────────────────────────────────────────────────────────
INSERT IGNORE INTO payment_terms (id, company_id, code, name, days, description, is_active, created_at, updated_at) VALUES
('pt000000-0000-0000-0000-000000000001', @company_id, 'COD',   'Cash on Delivery', 0,  'Payment upon delivery',              1, @now, @now),
('pt000000-0000-0000-0000-000000000002', @company_id, 'NET7',  'Net 7 Days',       7,  NULL,                                 1, @now, @now),
('pt000000-0000-0000-0000-000000000003', @company_id, 'NET14', 'Net 14 Days',      14, NULL,                                 1, @now, @now),
('pt000000-0000-0000-0000-000000000004', @company_id, 'NET30', 'Net 30 Days',      30, NULL,                                 1, @now, @now),
('pt000000-0000-0000-0000-000000000005', @company_id, 'NET60', 'Net 60 Days',      60, NULL,                                 1, @now, @now),
('pt000000-0000-0000-0000-000000000006', @company_id, 'DP50',  'Down Payment 50%', 30, '50% upfront, remainder on delivery', 1, @now, @now),
('pt000000-0000-0000-0000-000000000007', @company_id, 'DP30',  'Down Payment 30%', 30, '30% upfront, remainder on delivery', 1, @now, @now);

-- ── Material Categories ───────────────────────────────────────────────────────
INSERT IGNORE INTO material_categories (id, company_id, code, name, is_strategic, is_active, created_at, updated_at) VALUES
('mc000000-0000-0000-0000-000000000001', @company_id, 'RM',    'Raw Material',         1, 1, @now, @now),
('mc000000-0000-0000-0000-000000000002', @company_id, 'SP',    'Spare Parts',          0, 1, @now, @now),
('mc000000-0000-0000-0000-000000000003', @company_id, 'MRO',   'Maintenance & Repair', 0, 1, @now, @now),
('mc000000-0000-0000-0000-000000000004', @company_id, 'CAPEX', 'Capital Expenditure',  1, 1, @now, @now),
('mc000000-0000-0000-0000-000000000005', @company_id, 'PKG',   'Packaging',            0, 1, @now, @now),
('mc000000-0000-0000-0000-000000000006', @company_id, 'CONS',  'Consumables',          0, 1, @now, @now);

-- ── Locations ─────────────────────────────────────────────────────────────────
INSERT IGNORE INTO locations (id, company_id, name, type, city, country, is_active, created_at, updated_at) VALUES
('lo000000-0000-0000-0000-000000000001', @company_id, 'Main Warehouse',     'warehouse', 'Jakarta',       'Indonesia', 1, @now, @now),
('lo000000-0000-0000-0000-000000000002', @company_id, 'Production Plant A', 'plant',     'Cikarang',      'Indonesia', 1, @now, @now),
('lo000000-0000-0000-0000-000000000003', @company_id, 'Head Office',        'office',    'South Jakarta', 'Indonesia', 1, @now, @now);

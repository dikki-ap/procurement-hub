...
public interface IApprovalPolicyRepository
{
    ...
    Task<ApprovalPolicy?> FindMatchingAsync(Guid companyId, string referenceType, decimal totalValue, CancellationToken ct = default);
    ...
    void Remove(ApprovalPolicy policy);
